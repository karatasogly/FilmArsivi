...
<head>
    ...
    <style>
        ...
        .card { 
            ...
            position: relative; height: 420px; transition: 0.3s;
        ...
        .info { position: absolute; bottom: 0; left: 0; width: 100%; background: linear-gradient(transparent, rgba(0,0,0,0.9)); padding: 15px; z-index: 15; pointer-events: none; transition: 0.3s; }
        ...
        .delete-btn { position: absolute; top: 10px; right: 10px; z-index: 20; background: rgba(0,0,0,0.7); color: white; text-decoration: none; padding: 4px 8px; border-radius: 4px; font-size: 10px; }
    </style>
</head>
<body>
...
def index():
    try:
        ...
        return "<h3>Database Syncing... Please refresh.</h3>"
